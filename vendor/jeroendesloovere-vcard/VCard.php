...
class VCard
{
     ...
     * @return $this
     */
    public function addName($firstName = '')
    {
        // define values with non-empty values
        $values = array_filter([$firstName]);
     ...
     * @return $this
     */
    public function addImpp($impp)
    {
        $this->setProperty(
            'impp',
            'IMPP' . $this->getCharsetString(),
            $impp
            );
     ...
     * @return $this
     */
    public function addProdID($prodId)
    {
        $this->setProperty(
            'prodId',
            'PRODID' . $this->getCharsetString(),
            $prodId
            );
